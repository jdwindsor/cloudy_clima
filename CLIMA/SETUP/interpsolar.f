...
c       For pressures within the grid
        ...
        ELSE
        LS1 = LS-1
        PLOG=log10(press(LS)) ! upper grid boundary in log units
        PLOG1=log10(press(LS1)) ! lower grid boundary in log units
        P1L=log10(p1) ! location of pressure within grid in log units
