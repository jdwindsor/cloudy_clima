...
c  This subroutine does not contain CH4
...
C
   ...
   19   FORMAT(/1X,1PE10.4)
         ...
         END IF
C
c         DO 1180 K3=1,NPR3              !**BEGIN LOOP by Ch4 exp sums' coef
         DO 1170 K1=1,NPR1              !**BEGIN NPR1 LOOP**
            DO 1175 K2=1,NPR2           !**BEGIN NPR2 LOOP**
                AP=WGHT(K1,1,I)*WGHT(K2,2,I)
c               IF(I<22) THEN
c               AP=WGHT(K1,1,I)*WGHT(K2,2,I)*ALPHACH4(K3,I)
c               END IF
c               IF(I>21) THEN
c               AP=WGHT(K1,1,I)*WGHT(K2,2,I)*ALPHACH4NEW(K3)
c               END IF
               IG1=NGAS(1,I)
               IG2=NGAS(2,I)
C
...
c            TAUG(IL)= BETACH4(K3,I)*CGAS(IL,5)
c            END IF           
          IF (I>100) THEN            
c         IF(I>21) THEN
         II = I - 21
