...
c-----------------------------------------------------------------------------------------           
           ...
           CALL RAYLEY(SIGR_cloudy,AL2,Fwater,FNCR)
...
C
       ...
       TAUASTOTAL_cloudy = TAUASTOTAL + TAUAS_cloudy(IL) !JDW
       ENDDO
       ENDIF
...
!                TAUCONTSOL(IL) = 0.0d0
                TAUCONTSOL_cloudy(IL) = ABSCONT*CGAS(IL,6) !JDW
...
!                   IF(IG2.EQ.3) THEN
     ...
     &                             /2.687E19)*FI_cloudy(2,IL)*P(IL)                                                 !in inverse amagat^2cm. So tau is unitless.
                     ENDDO
