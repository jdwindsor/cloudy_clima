...
C   PRESSURE-INDUCED CO2 ABSORPTION (FROM JIM POLLACK) AND FROM GRUSZKA AND BORYSAW (1998) BARANOV ET AL. (2004)
      DATA CPR/2.7E-5, 5.5E-5, 1.8E-5, 4.5E-6, 1.4E-6, 4.5E-7, 2.3E-7,
     2  5.4E-7, 1.6E-6, 10*0., 4.E-7, 5.E-6, 2.3E-5, 2.5E-5,
     3  3.8E-6, 2.0E-7, 5.0E-8, 3.0E-8, 28*0./
c-jdh No 20-um band
