...
C  !  !                                                                  ! FA00520
      COMMON /PROFI/ NLAYRS,PBAR(MXLAY),TBAR(MXLAY),
...
c     *            HVRD1M,HVRR1M,HVREPK,HVRLPK,HVRAER,HVRBKA,!
c     *            HVRBKB,HVRCLD,HVRDIS,HVRLAM,HVRPAR!
...
C  !  !                                                                  ! FA10430
      STOP ' ZBND'  !  !                                                 ! FA10440
!  !  !                                            
c  301 PRINT 988,(ZTMP(I),I=2,IBMAX)  !  !                                         
...
c  928 FORMAT (//,' MULTIPLE SCATTERING TURNED OFF, HMIN = ',F10.6,!    ! FA10810
 ...
 951  FORMAT (/,T4,'I',T11,'Z',T20,'P',T29,'T',T35,'REFRACT',T45,               
  ...
  968 FORMAT ('1 SUMMARY OF THE GEOMETRY CALCULATION',//,10X,          ! FA11250
     ...
     *        /,10X,'LEN     = ',I10,/,10X,'AIRMAS  = ',G13.6,         ! FA11310
  ...
  992 FORMAT (///,' ERROR: EITHER AVTRAT.LE.1.0 OR TDIFF.LE.0',/,      ! FA11670
     *        '0PROGRAM STOP  -  AVTRAT = ',E13.6,' TDIFF1 = ',F10.4,  ! FA11680
...
C  !  !                                                                  ! FA27230
 ...
 915  FORMAT ('0',I4,1X,'(ALT:KM)=',F7.3,4X,'(P:',A1,')=',G12.5,4X,             
     *        '(T:',A1,')=',F8.3,/,(5X,7(' (',I2,':',A1,')=',1PE10.3)))
 916  FORMAT ('0',I4,1X,'(ALT:KM)=',F7.3,4X,'(P:',A1,')=',G12.5,4X,
...
C!  !  !                                           
C 70      IF (JUNITT.GT.6 .OR. JUNITT.NE.J_MDL) GO TO 80
         MATM = JUNITT  !  !                                             ! FA29630
C  !  !                                                                  ! FA29640
...
c  925 FORMAT (//,10X,'CALCULATED H2 IS LESS THAN ZERO:',/,10X,         ! FA34030
c     *        'RESET H2 = 0.0 AND RANGE = ',F10.3)                     ! FA34040
 ...
 937  FORMAT (///,' SLANT PATH PARAMETERS AT SATELLITE',/                       
  ...
  965 FORMAT (' FSCGEO:  THE ENTIRE PATH LIES ABOVE THE TOP ZMAX ',    ! FA34260
     *        'OF THE ATMOSPHERIC PROFILE',//,10X,'ZMAX = ',G13.6,5X,  ! FA34270
     *        '  H1 = ',G13.6,5X,'  H2 = ',G13.6,'  HMIN = ',G13.6)    ! FA34280
C  !  !                                                                  ! FA34290
...
C  !  !                                                                  ! FA45350
      ...
      logX = 1.-X  !  !                                                 ! FA45390
      IF (ABS(logX).LT.0.001) THEN                                    ! FA45400
      ...
      logY = 1.-Y  !  !                                                 ! FA45470
      IF (ABS(logY).GT.0.001) logY =  LOG(Y)                         ! FA45480
      ZBND(IB) = ZMDL(IM-1)+(ZMDL(IM)-ZMDL(IM-1))*logY/logX          ! FA45490
   50 CONTINUE  !  !                                                     ! FA45500
C  !  !                                                                  ! FA45510
...
C     L'TH LAYER, ANlogOUS TO AMOUNT IN /SPECIES/ FOR THE STANDARD
C     MOLECULES.  !  !                                                  !  FX00800
C  !  !                                                                 !  FX00810
